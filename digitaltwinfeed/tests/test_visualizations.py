...
def test_grouped_visualization():
    ...
    df = pd.DataFrame({
        'location': ['SF Zoo', 'SF Zoo', 'SF Zoo', 'LA Zoo', 'LA Zoo', 'LA Zoo'],
        'animal': ['giraffes', 'orangutans', 'monkeys', 'giraffes', 'orangutans', 'monkeys'],
    ...
    layout = {'title': 'Animal Count | Group Plot', 'xaxis': {'tickangle': -45}, 'barmode': 'group'}
