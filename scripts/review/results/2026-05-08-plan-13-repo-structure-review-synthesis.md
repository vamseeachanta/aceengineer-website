# Plan review synthesis for #13: chore(repo-structure): normalize aceengineer-website folder/file structure
...
- Preserve approval SHA in `.planning/plan-approved/13.md` after approval.
