...
<html>
    ...
    <body bgcolor="DDDDDD">
        <html:form action="/delete" onsubmit="return valid()">
            <table width="400" class="entire">
                <tr>
                    <td>
                                ...
                                <tr>
                                    <td>
                                        <table border="1" id="cond_tab">
                                            <th> Condition </th>
                                            <logic:iterate id="cond" name="delete_DataForm" property="cond" >
                                    ...
                                    <td>
                                        <table border="1" id="dev_tab">
                                            <th> Development </th>
                                            <logic:iterate id="dev" name="delete_DataForm" property="dev">
                                    ...
                                    <td>
                                        <table border="1" id="hs_tab">
                                            ...
                                            <logic:iterate id="hs" name="delete_DataForm" property="hs">
                        ...
                        <center>
                            <html:submit value="Go" onclick="return valid1()"/>
                        </html:form><br><br>
                    </center>
                </td>
            </tr>
