                ...
                <tr>
                    <td>
                       <table width="840" cellpadding="0" cellspacing="0" class="header">
                        ...
                        <html:form action="/returnperiod1">
                            <center>
                                <b> Previous Selected Data is : Metocean/Extreme Current </b><br><br>
                                <b> Select from the following return periods :</b><br><br>

                                <h5><bean:write name="returnperiodform1" property="error" filter="false"/></h5>
                                <table border="0">
                                    <tr>
                                        <td>
                                            <b>100-YEARS RETURN</b></td>
                                        <td>
                                            <html:radio property="returnperiod1" value="100"/></td></tr>
                                    <tr>
                                        <td>
                                            <b>10-YEARS RETURN</b></td>
                                        <td> <html:radio property="returnperiod1" value="10"/></td>
                                    </tr>
                                    <tr>
                                        <td><b>1-YEAR RETURN</b></td>
                                        <td><html:radio property="returnperiod1" value="1"/></td>
                                    </tr>
                                </table>
