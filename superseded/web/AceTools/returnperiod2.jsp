                ...
                <tr>
                    <td>
                       <table width="840" cellpadding="0" cellspacing="0" class="header">
                        ...
                        <html:form action="/returnperiod2">
                            <center>
                                
                                <b>Previous selected data is : Metocean/Long Current </b><br><br>
                                <b> Select from the followings :</b><br><br>

                                <h5><bean:write name="returnperiodform2" property="error" filter="false"/></h5>

                                <table border="0">
                                    <tr>
                                        <td>
                                            <b>Development Current Profiles</b></td>
                                        <td>
                                            <html:radio property="returnperiod2" value="dd"/></td></tr>
                                    <tr>
                                        <td>
                                            <b>Compare Exceedance Currents between Developments</b></td>
                                        <td> <html:radio property="returnperiod2" value="cd"/></td>
                                    </tr>
                                </table>
