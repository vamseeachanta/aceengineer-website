            ...
            <table width="840" class="entire">
                <tr>
                    <td>
                        ...
                        <html:form action="/vtype">
                            <center>
                                <h4> Select Any one of the following vessel-types</h4>
                                <table border="0">
                                    <tr>
                                        <td>
                                            <b>TLP</b></td>
                                        <td>
                                            <html:radio property="v_riser" value="tlp"/></td></tr>
                                    <tr>
                                        <td>
                                            <b>SEMI</b></td>
                                        <td> <html:radio property="v_riser" value="semi"/></td>
                                    </tr>
