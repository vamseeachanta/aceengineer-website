...
<div class="grid_12" style="padding-top: 16px;">
     ...
     <div class="grid_2" style="margin-left:0px;">
            <div class="img-wrap">
                    <img id="RamaKrishnaPHCss" class="img_2" src="AceEngineerimages/Photos/RK_new.jpg" style="height: 60%; width: 80%;" alt="Image 3"/>
                <!--<img class="img_2" style="width: 70%;height: 70%;" src="images/index-1_img03.jpg" alt="Image 3"/>-->
            </div>
         <div>
    <p  class="text_6">
        <a class="StaffTabs NavigateToTeam" href="#RamaKrishna">Rama Krishna A</a>
    ...
    <div class="grid_2">
            <div class="img-wrap">
                    <img id="VamseeAchantaPHCss" class="img_2" src="AceEngineerimages/Photos/VA_new.jpg" style="height: 60%; width: 80%;" alt="Image 3"/>
                <!--<img class="img_2" style="width: 70%;height: 70%;" src="images/index-1_img03.jpg" alt="Image 3"/>-->
            </div>
        <div>
    <p  class="text_6">
          <a class="StaffTabs NavigateToTeam"   href="#VamseeAchanta">Vamsee Achanta</a>
    ...
    <p  class="text_6">
        ...
        <div class="row OffStaff indent_3" id="RamaKrishna1">

           
                
                   <div class="grid_12">
                <div class="box_4">
                    <b class="text_2">Rama Krishna A</b>
                    <p class="text_89" style="padding-bottom: 1%;">Managing Director & Chief Mentor</p>
                    <!--<p class="text_89" style="padding-bottom: 1%;">CEO</p>-->
                    <p class="text_3" style="text-align: justify;">
                <!--Rama Krishna A is the Chief Executive Officer (CEO) and Managing Director of AceEngineer. In this 34 years tenure as civil engineer, he has vast experience in the construction of Roads, Bridges and buildings in Roads and Buildings department in Andhra Pradesh Government. He has supervised, managed, engineered and help construction of several roads, bridges and buildings. He is currently responsible for marketing and day to day activities at AceEngineer. He is also project manager for all ongoing projects-->
                In this 34 years tenure as civil engineer, he has vast experience in the construction of Roads, Bridges and buildings in Roads and Buildings department in Andhra Pradesh Government. He has supervised, managed, engineered and help construction of several roads, bridges and buildings. He is currently responsible for marketing and day to day activities at AceEngineer. He is also project manager for all ongoing projects.
       ...
       <!--Boss VA-->
        <div class="row OffStaff indent_3" id="VamseeAchanta1">
                
                   <div class="grid_12">
                <div class="box_4">
                    <b class="text_2">Vamsee Achanta</b>
                     <p class="text_89" style="padding-bottom: 1%;">Consultant</p>
                    <p class="text_3" style="text-align: justify;">
    Vamsee Achanta (VA) is the Chief Executive Officer (CEO) and Managing Director of AceEngineer. He is also the consultant of AceEngineer. He is a professional engineer licensed in the state of Texas and has 10 years of engineering and senior managerial experience in oil and gas services industry. He has MS in Mechanical engineering from Texas A&M University (TAMU) and B Tech in mechanical engineering from Indian Institute of Technology, Madras (IIT).            
...
Dinesh chakravarthy (JD) is Senior Software engineer for AceEngineer. He has over 5+ years of experience on java and successfully handles the couple of web applications and mobile apps. He has MCA from Andhra University. 
...
Venkat Sana (VS) is senior software developer of AceEngineer applications. He has over 3+ Years of experience on java and successfully handles the couple of web applications and mobile apps. He has B.Tech from JNTUK.
