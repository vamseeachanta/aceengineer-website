...
//		var dataString = {'fullname':fullname, 'email':email, 'phone':phone, 'subject':subject, 'message':message, 'vpb_captcha_code':vpb_captcha_code, 'submitted':'1'};
		var dataString = { 'email':email,'subject':subject, 'message':message, 'vpb_captcha_code':vpb_captcha_code, 'submitted':'1'};
		
		//Show loading image
		$("#response_brought").html('<br clear="all"><div align="left" style=" padding-top:6px; margin-left:100px; margin-top:15px;"><font style="font-family:Verdana, Geneva, sans-serif; font-size:12px; color:black;">Please wait</font> <img src="captcha/images/loading.gif" alt="Loading...." align="absmiddle" title="Loading...."/></div>');
