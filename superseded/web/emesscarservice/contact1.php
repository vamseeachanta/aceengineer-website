...
if ($action=="")    /* display the contact form */ 
	...
	if (($name=="")||($email=="")||($number=="")||($message=="")) 
        { 
        echo '<h2 style=" color:#a5a5a5;  text-align:center; margin-top:10px; font-size:17px; font-family:arial; font-weight:normal;">All fields are required, please fill <a href=contactus.php  style=" color:#d76f1c;">the form</a> again.</h2>'; 
        } 
    else{         
