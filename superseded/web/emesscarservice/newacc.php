...
<li><a href="http://www.emesscarservice.com">ONLINE BOOKING</a>
...
if ($action=="")    /* display the contact form */ 
    ...
    if (($fname=="")||($email=="")||($sname=="")||($address=="")||($pincode=="")||($contact=="")||($mobile=="")||($payment=="")) 
        { 
        echo '<h2 style=" color:#a5a5a5;  text-align:center; margin-top:10px; font-size:17px; font-family:arial; font-weight:normal;">All fields are required, please fill <a href=newaccount.php  style=" color:#d76f1c;">the form</a> again.</h2>'; 
        } 
    else{         
        $from="Company Name: $cname\n\rFirst Name: $fname\n\rSurName: $sname\n\rAddress: $address $address1\n\rPostcode: $pincode\n\rContact: $contact\n\rMobile: $mobile\n\rEmail: $email\n\rPayment Method: $payment"; 
        $subject="Message sent using your contact form"; 
        mail("sheikibrahim11@gmail.com", $fname, $from); 
...
<h2 style=" color:#a5a5a5;  text-align:center; margin-top:10px; font-size:17px; font-family:arial; font-weight:normal;">Your form  has been received<br />We will endevour to respond as soon as possible</h2> ';
        } 
    }   
?> 
