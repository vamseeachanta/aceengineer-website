        ...
        <div align="center">
            <table class="content" width="990" style="height: 500px;" border="0">
                    ...
                    <td  height="35px" class="menu" colspan="2">
                        <ul class="dropMenu">
                            ...
                            <!--                            <li><a href="#">Philosophy</a></li>
                                                        <li><a href="#">Forex Watch</a></li>
                                                        <li><a href="#" >Stock Analysis</a>
                ...
                <tr id="public_Forex" class="public_tabs">
                    <td colspan="2" valign="top">
                        <jsp:include page="TempCurrencyConversion.jsp"/>
                    </td>
                </tr>
                    ...
                    <td style="vertical-align: top">
                        <blockquote>
                            <div class="contentDiv border10">
                                ...
                                <p>
                                    You can't explore our features with out an account. but we provide you a guest account
                                    that will explains all the feature with limited functionality try <a href="ipHandler.do">here</a>.
                                </p>
                            </div>
                        </blockquote>
                    </td>
                    <td valign="top">
                        <html:form action="/registration" styleClass="regForm">
                            ...
                            <table  class="formFields">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <input type="checkbox" name="checkbox" style="width: 50px"/>I agree to the AceEngineer <a style="color: #2878C0">Terms of Services</a>
