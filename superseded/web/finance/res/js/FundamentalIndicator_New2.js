...
var FundamentalIndicatorHandler = {
    ...
    {     
        ...
        if(drawMode == 0)
        {
            pChart.draw(pChartDataView, {
                colors:["000000","00FF00","0000FF","0000FF","FF0000","FF0000","FF0000","FF0000"],
    ...
    {   
        ...
        append("<input type='checkbox' name='maChk' value='EMA' />50-Day").
        ...
        function myHandler(data)
        {
            ...
            try
            {
                ...
                for(var i=0;i<dates.length;i++,counter++)
                {
                    ...
                    rows[i] = [dates[i],ma1[i],rcmds[i],ma5[i],ma13[i],EMA[i],lB[i],uB[i],ext_lB[i],ext_uB[i],bMa1[i],bMa5[i],bMa13[i],bMa50[i]];
