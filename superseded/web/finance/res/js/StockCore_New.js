    ...
    $(items).keydown(function(evt)
    {
        ...
        switch(keyCode)
        {
            case 13:
                ...
                // alert($(r).find('td').eq(0).html());
                //alert($(r).find('td').eq(2).html());
                var typDisp = $(r).find('td').eq(2).html();
                if(r.length > 0){
        ...
        {                        
            ...
            try
            {
                ...
                {         
                    ...
                    content += "<tr><td style='border-right:1px solid white'>"+field.symbol+"</td><td>&reg;"+field.name+"</td><td>"+field.typeDisp+"</td><td>"+field.exch+"</td></tr>";
                }
                content += "</table>";
                //alert(content);
