...
<html>
    ...
    <body bgcolor="DDDDDD">
        <html:form action="/data" onsubmit="return valid()">
            <table width="500" class="entire">
                <tr>
                    <td>
                                ...
                                <tr>
                                    <td>
                                        <table border="1" id="cond_tab">
                                            <th> Condition </th>
                                            <logic:iterate id="cond" name="insertForm" property="cond" >
                                    ...
                                    <td>
                                        <table border="1" id="dev_tab">
                                            <th> Development </th>
                                            <logic:iterate id="dev" name="insertForm" property="dev">
                                    ...
                                    <td>
                                        <table border="1" id="hs_tab">
                                            ...
                                            <logic:iterate id="hs" name="insertForm" property="hs">
