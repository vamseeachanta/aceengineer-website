                ...
                <tr>
                    <td>
                       <table width="840" cellpadding="0" cellspacing="0" class="header">
                        ...
                        <html:form action="/rao">
                            
                            <center>
                               
                                <h4> Select from the RAO DATA ANGLE</h4>
                                <h5><bean:write name="raoform" property="error" filter="false"/></h5>
                                <table>
                                    <tr><td>
                                            <b>HEADING ANGLE:    0</b>
                                            <html:checkbox   property="rao" value="10"/></td></tr>
                                    <br>
                                    <tr><td>
                                            <b>HEADING ANGLE:   -15</b>
                                            <html:checkbox property="rao1" value="-15" /></td></tr>
                                </table>
                                <html:submit value="Click"/>
                                <html:reset/>

                            </center> </html:form><br><br>
