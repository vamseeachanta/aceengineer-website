...
//    this.dgData;
//}
//DynamicTable.prototype.loadData = function(colNames) {
// this.dgColumns = colNames;
// //alert(this.dgColumns);
// //this.dgData = dgValues;
// this.eventHandlers(this.dgColumns);
// 
// //this.eventHandlers();
// //this.showGrid(this);
// 
//}
//DynamicTable.prototype.eventHandlers = function(thData) {
//    //alert("elements: "+thData.length);
// //var elements = this.table.getElementsByTagName("th");
// var elements = thData;
// //this.table.getE
//alert(elements.length);
// for (var x = 0; x < elements.length; x++) {
//  //var columnName = elements[x];
//  //alert(columnName[x]);
//  //alert(elements[x]);
//  addListener(elements[x], "click", false);
// } 
// 
//}
//
...
//  element.addEventListener(type, bubbling);
//  return true;
...
//            element.addEventListener(type, bubbling); return true; 
//        } else if(window.attachEvent) {
//            element.attachEvent('on' + type); return true; 
//        } else 
//            return false; 
//    }
