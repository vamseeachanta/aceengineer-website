...
(function(a){
        ...
        for(;c<cm.length;c++){
            ...
            if(e<f){
                ...
                if(d.repeat>1&&!d.next){
                    for(s in k)k[g](s)&&(r[s]=d.totalOrigin[s]);d.el.attr(r),cs(d.anim,d.el,d.anim.percents[0],null,d.totalOrigin,d.repeat-1)
                }
    ...
    b_.animateWith=function(b,c,d,e,f,g){
        ...
        b=Object(b),c=+c||0;
        var f={},h,i;
        for(i in b)b[g](i)&&Q(i)!=i&&Q(i)+"%"!=i&&(h=!0,f[i]=b[i]);if(!h)return new cr(b,c);
