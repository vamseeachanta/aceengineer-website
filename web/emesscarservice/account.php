    ...
    <body>
        <div class="total">
            <div class="total_in">
                ...
                <section style="padding: 5% 10% 10%;">
                    <!--<div style=" height:450px; margin-top:30px; margin-left:30px; margin-right:30px; margin-bottom:100px; ">-->
                    <div align="center" >
                        <div class="v_gap"></div>
                        <div align="center">
                            <h2 id="acc3">
                                <div class="title5">
                                    Account <span class="title6">Set up</span>
                                </div>
                            </h2>
                        </div>
                        ...
                        <div id="acc2" >
                            <div id="acc" >
                                <a href="newaccount.php"><img src="Images/hand.png" class="example"/></a>
                                <!--                            </div>
                                                            <div id="acc1  example" style="border:1px solid red;">-->
                                <a href="existingaccount.php"><img src="Images/account2.png" class="example" /></a>
                            </div>
                        </div>
                    </div>
                </section>
