  ...
  left: '50%' // Left position relative to parent
    ...
    $("#DropdownBlogDate").change(function() {
        ...
        try
        {
            ...
            $.ajax({
                type: "POST",
                url: "DataBase_Base641.php",
                data: "Mode=" + "GetSelectedContent" + "&Heading=" + SelectedValue,
        ...
        success: function(result) {
            ...
            if (res.length !== 0) {
                ...
                for (var i = 0; i < res.length; i++) {
                    ...
                    options += '<option value=' + res[i].Heading + '>' + res[i].Heading + '</option>';
...
function Update() {
    ...
    {
        var SelectedHeading = $("#DropdownBlogDate option:selected").text();
        var content = encodeURIComponent($('#summernote').code());
        ...
        $.ajax({
            data: "Mode=" + "UpdateMode" + "&UpdateContent=" + content + "&SelectedHeading=" + SelectedHeading + "&BlogHeading=" +Heading + "&BlogUrlHeading=" +BlogUrlHeading ,
            type: "POST",
            url: "DataBase_Base641.php",
            success: function(res) {
                alert(res);
...
function Delete()
{
    if ($("#DropdownBlogDate option:selected").text() !== "Choose")
    {
        ...
        if (Confirm)
        {
            ...
            $.ajax({
                data: "Mode=" + "DeleteMode" + "&SelectedHeading=" + SelectedHeading,
                type: "POST",
                url: "DataBase_Base641.php",
                success: function(res) {
                    alert(res);
